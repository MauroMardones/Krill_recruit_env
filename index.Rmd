...
```{r Figure2, fig.height=2, fig.width=9, fig.cap="Krill Recruit index by strata"}
...
```{r Figure3, fig.height=8, fig.width=7, fig.cap="Coorrelation plot to different variables."}
